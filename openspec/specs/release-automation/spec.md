...
## Purpose
Creación automática de la GitHub Release de cada versión a partir de la tag SemVer y de la sección correspondiente de `CHANGELOG.md`, mediante GitHub Actions.
