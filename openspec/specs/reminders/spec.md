...
Recordatorios (`Reminder`): notas con fecha para el futuro (citas, compromisos, tareas), gestionables desde la web, con listados paginados de próximos y pasados, aviso diario por Telegram, y un indicador global visible en toda la aplicación.
