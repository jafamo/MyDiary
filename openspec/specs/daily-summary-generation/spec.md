...
El sistema SHALL comprobar si existen `AudioRecording` del día en curso en estado `PENDING`, y SHALL esperar con reintentos periódicos durante una ventana corta antes de continuar, para no excluir transcripciones casi listas.
